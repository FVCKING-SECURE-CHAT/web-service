    ...
    return (
        <div className="w-full flex h-screen flex-col items-center justify-center p-4 lg:p-0">
            ...
            <div className='w-full md:w-96 font-geist-sans h-auto bg-white shadow-lg border border-border p-6 rounded-lg'>
                ...
                <p className="text-zinc-800 opacity-70">Please signin to continue</p>
                <div className="mt-1.5">
                    <Label className="text-primary/70" htmlFor="username" title="Username">Username</Label>
                    <Input disabled={auth.loading} type="text" id="username" name="username" className="px-2 py-1.5 h-fit rounded-md ring-ring/30 ring-1 active:ring-2 focus:ring-2 duration-200 transition-all" value={username} onChange={(e) => setUsername(e.currentTarget.value)} />
                </div>
                ...
                <div className="mt-4 space-y-2">
                    ...
                    <div className="flex flex-row gap-1 text-zinc-800/70 text-sm">
                        No account ? <a href="/signup" className="text-zinc-800 underline underline-offset-4">Register</a> here.
                    </div>
                </div>
            </div>
